...
def nuget_deps():
    nuget_fetch(
        ...
        packages = {
            ...
            "Microsoft.Build.Tasks.Core/18.6.3": ["net10.0"],
            "Microsoft.Build.Utilities.Core/18.6.3": ["net10.0"],
            "Microsoft.NET.StringTools/18.6.3": ["net10.0"],
            "Microsoft.NET.Test.Sdk/16.7.1": ["net5.0", "net10.0"],
            "Moq/4.16.1": ["net5.0", "net10.0"],
            "Newtonsoft.Json/13.0.1": ["net10.0"],
            "SamHowes.Microsoft.Build/18.6.3": ["net10.0"],
